...
class TechnologyDeviceAPITest {
    ...
    @AfterEach
    void tearDown() {
        emptyDevices= populatedDevices=null;
    }
    @Nested
    class GettersAndSetters {
void gettingTchnologyListReturnsList(){
    assertEquals(populatedDevices.getTechnologyList(), populatedDevices.getTechnologyList());
    assertEquals(emptyDevices.getTechnologyList(), emptyDevices.getTechnologyList());
}//generated by  ai Qwen at 23:15 05/19/2024
    }
    ...
    class ReportingMethods {
        @Test
        void topFiveMostExpensiveTechnologyReturnsNoTechnologyDevicesWhenNoneExist() {
            assertEquals(0, emptyDevices.numberOfTechnologyDevices());
            String emptyDeviceStr = emptyDevices.topFiveMostExpensiveTechnology().toString();
            assertTrue(emptyDeviceStr.contains("No technology devices"));
        }//generated by  ai Qwen at 23:26 05/19/2024
    }

    @Nested
    class SearchingMethods {
        @Test
        void searchByManufacturerReturnsNoTechnologyDevicesWhenNoneExistForEnteredManufacturer() {
            assertEquals(4, populatedDevices.numberOfTechnologyDevices());
            String populatedDeviceStr = populatedDevices.listAllTechDevicesByChosenManufacturer(hitachi);
            assertTrue(populatedDeviceStr.contains("No technology devices from"));
        }//generated by  ai Qwen at 23:25 05/19/2024
    }
